...
--------------------------------------------------------------------------------------------------------------------------
DROP TABLE IF EXISTS Persons
CREATE TABLE Persons (PersonID int NOT NULL UNIQUE,
                      LastName varchar(50) NOT NULL,
                      FirstName varchar(50) NOT NULL,
                      Age int, 
                      Gender varchar(50),
...
ALTER TABLE Persons
ADD CONSTRAINT UC_Person UNIQUE (Age); -- Name UNIQUE Constraint


-- Drop UNIQUE Constraint
ALTER TABLE Persons
DROP CONSTRAINT UC_PersonC -- Drop the named constraint column.

ALTER TABLE Persons
DROP CONSTRAINT UQ__Persons__3D6B64BD727595FC -- Drop with unique Constraint Name
...
INSERT INTO Persons VALUES (1001, 'Jim', 'Halpert', 30, 'Male', DEFAULT);
...
CREATE TABLE Persons (ID int NOT NULL,
                      ...
                      Gender varchar(50),
                      City varchar(50),
                      CONSTRAINT CHK_Person CHECK (Age>=18 AND City='Scranton')
                      );
...
ON Persons (LastName); -- You can create an index on a single or multiple columns.

-- SHOW INDEX 
EXEC sp_helpindex 'Persons'

-- DROP INDEX Statement
DROP INDEX IF EXISTS Persons.idx_lastname;

DROP INDEX IF EXISTS idx_lastname ON Persons;
