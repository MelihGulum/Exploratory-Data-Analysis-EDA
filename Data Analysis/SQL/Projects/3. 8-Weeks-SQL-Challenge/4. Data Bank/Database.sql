...
--The INSERT statement broken up into parts, because the maximum number of row value expressions in INSERT statement only 1000 rows.
...
--The INSERT statement broken up into 6 parts, because the maximum number of row value expressions in INSERT statement only 1000 rows.
